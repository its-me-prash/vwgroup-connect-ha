...
- **Browser / device-code (passwordless)** for *Audi, Škoda, SEAT, CUPRA and Audi US/CA*. Sign in on your phone or laptop and approve the device; no password is stored in Home Assistant (it keeps a real refresh token). This step also offers the optional **S-PIN** and scan interval.
