...
| **VW US/CA** | ✅ Two-way | ✅ Full | VW NA cloud (needs the US/CA country selector + S-PIN). ⚠️ Canadian sign-ins were being routed to a host with no working authorize endpoint; fixed in v2.26.1 and awaiting confirmation from a live Canadian account ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **North America is experimental.** **Audi US/CA** login is wired but has never been confirmed against a live account ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW US/CA** works, and a routing fault that broke some Canadian sign-ins was fixed in v2.26.1, though nobody has confirmed it against a live Canadian account yet ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Don't pick this integration for a North-American car expecting it to just work.
