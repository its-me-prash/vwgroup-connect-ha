...
| **VW US/CA** | ✅ Two-way | ✅ Full | VW NA cloud (needs the US/CA country selector + S-PIN). Canada now signs in on its own server with its own app client and shows full data, confirmed on a live Canadian ID.4 ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **North America is mostly VW; Audi is still experimental.** **VW US/CA works, including Canada**, now confirmed against a live Canadian ID.4: Canada signs in on its own server, and since the data-envelope fix it shows full telemetry ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). **Audi US/CA** login is wired but has never been confirmed against a live account ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)), so treat a North-American Audi as experimental.
