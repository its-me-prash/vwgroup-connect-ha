...
| **VW USA/CA** | ✅ Obousměrné | ✅ Plné | cloud VW NA (vyžaduje volbu země USA/CA + S-PIN). ⚠️ Kanadská přihlášení byla směrována na server bez funkčního koncového bodu authorize; opraveno ve v2.26.1 a čeká se na potvrzení ze skutečného kanadského účtu ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Severní Amerika je experimentální.** Přihlášení **Audi USA/CA** je zapojené, ale nikdy nebylo potvrzeno na skutečném účtu ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** funguje a chyba směrování, která rozbíjela část kanadských přihlášení, byla opravena ve v2.26.1, potvrzení na skutečném kanadském účtu ale zatím nikdo nedodal ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Nevybírejte si tuhle integraci pro severoamerické auto s očekáváním, že prostě pojede.
