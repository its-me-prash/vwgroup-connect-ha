...
| **VW USA/CA** | ✅ Dwukierunkowe | ✅ Pełne | chmura VW NA (wymaga wyboru kraju USA/CA + S-PIN). ⚠️ Kanadyjskie logowania trafiały na host bez działającego punktu końcowego authorize; naprawione w v2.26.1 i czekają na potwierdzenie z prawdziwego kanadyjskiego konta ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Ameryka Północna jest eksperymentalna.** Logowanie **Audi USA/CA** jest podpięte, ale nigdy nie zostało potwierdzone na prawdziwym koncie ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** działa, a błąd routingu, który psuł część kanadyjskich logowań, został naprawiony w v2.26.1, choć nikt nie potwierdził tego jeszcze na prawdziwym kanadyjskim koncie ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Nie wybieraj tej integracji do auta z Ameryki Północnej w oczekiwaniu, że po prostu zadziała.
