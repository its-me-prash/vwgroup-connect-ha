...
| **VW USA/CA** | ✅ Toveis | ✅ Full | VW NA-skyen (krever landvelgeren USA/CA + S-PIN). ⚠️ Kanadiske innlogginger ble rutet til en tjener uten et fungerende authorize-endepunkt; rettet i v2.26.1, og bekreftelse fra en ekte kanadisk konto avventes ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Nord-Amerika er eksperimentelt.** Innloggingen for **Audi USA/CA** er koblet opp, men er aldri bekreftet mot en ekte konto ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** virker, og en rutingfeil som ødela enkelte kanadiske innlogginger ble rettet i v2.26.1, men ingen har ennå bekreftet det mot en ekte kanadisk konto ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Ikke velg denne integrasjonen til en nordamerikansk bil og forvent at den bare virker.
...
- **Styring:** låsing/opplåsing, klima start/stopp, lading start/stopp, rutevarme, avreisetimere, sette mål-SoC / temperatur / maks. ladestrøm, tut-og-blink (med valgbar varighet, og enten bare lys eller horn i tillegg), vekking, oppdatering, finn ladestasjoner *(tilgjengelighet avhenger av merke og modell)*.
