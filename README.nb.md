...
> **Fullstendig feltliste.** VW-konsernets komplette offisielle dataordbok (hver EU Data Act-nøkkel -> felt, beskrivelse og enhet) finnes i [docs/EU_DATA_ACT_DATA_DICTIONARY.md](docs/EU_DATA_ACT_DATA_DICTIONARY.md).
