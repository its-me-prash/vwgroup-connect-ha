...
| **VW USA/CA** | ✅ Tvåväg | ✅ Fullständig | VW NA-molnet (kräver landsväljaren USA/CA + S-PIN). ⚠️ Kanadensiska inloggningar dirigerades till en värd utan fungerande authorize-endpoint; åtgärdat i v2.26.1 och inväntar bekräftelse från ett riktigt kanadensiskt konto ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Nordamerika är experimentellt.** Inloggningen för **Audi USA/CA** är kopplad men har aldrig bekräftats mot ett riktigt konto ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** fungerar, och ett dirigeringsfel som slog ut en del kanadensiska inloggningar åtgärdades i v2.26.1, men ingen har ännu bekräftat det mot ett riktigt kanadensiskt konto ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Välj inte den här integrationen till en nordamerikansk bil och förvänta dig att den bara fungerar.
