...
| **VW EE. UU./CA** | ✅ Bidireccional | ✅ Completo | nube VW NA (necesita el selector de país EE. UU./CA + S-PIN). ⚠️ Los accesos canadienses se estaban enrutando a un host sin un endpoint de autorización operativo; corregido en la v2.26.1 y a la espera de confirmación desde una cuenta canadiense real ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Norteamérica es experimental.** El inicio de sesión de **Audi EE. UU./CA** está cableado pero nunca se ha confirmado contra una cuenta real ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW EE. UU./CA** funciona, y un fallo de enrutado que rompía algunos accesos canadienses se corrigió en la v2.26.1, aunque todavía nadie lo ha confirmado contra una cuenta canadiense real ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). No elijas esta integración para un coche norteamericano esperando que funcione sin más.
