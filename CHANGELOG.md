...
### Changed
- **New app icon.** The project now uses the VW Group Connect ID.Buzz artwork — cut full-bleed to the navy square's exact rounded edge, with no light halo — as its icon/logo across the integration and the README.
