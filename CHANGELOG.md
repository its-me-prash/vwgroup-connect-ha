...
### Changed
- **New app icon.** The project now uses the VW Group Connect ID.Buzz artwork — cleanly cut to its exact rounded edge — as its icon/logo across the integration and the README.
