...
| **VW VS/CA** | ✅ Tweeweg | ✅ Volledig | VW NA-cloud (vereist de VS/CA-landkeuze + S-PIN). ⚠️ Canadese logins werden naar een host geleid zonder werkend authorize-endpoint; verholpen in v2.26.1 en in afwachting van bevestiging door een echt Canadees account ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Noord-Amerika is experimenteel.** De **Audi VS/CA**-login is bedraad maar is nooit tegen een echt account bevestigd ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW VS/CA** werkt, en een routeringsfout die sommige Canadese logins brak is in v2.26.1 verholpen, al heeft nog niemand dat tegen een echt Canadees account bevestigd ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Kies deze integratie niet voor een Noord-Amerikaanse auto in de verwachting dat het zomaar werkt.
