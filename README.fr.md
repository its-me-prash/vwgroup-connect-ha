...
| **VW US/CA** | ✅ Bidirectionnel | ✅ Complet | cloud VW NA (nécessite le sélecteur de pays US/CA + S-PIN). ⚠️ Les connexions canadiennes étaient dirigées vers un hôte dépourvu de point de terminaison d'autorisation fonctionnel ; corrigé en v2.26.1, en attente de confirmation sur un compte canadien réel ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **L'Amérique du Nord est expérimentale.** La connexion **Audi US/CA** est câblée mais n'a jamais été confirmée sur un compte réel ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW US/CA** fonctionne, et un défaut de routage qui cassait certaines connexions canadiennes a été corrigé en v2.26.1, mais personne ne l'a encore confirmé sur un compte canadien réel ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Ne choisissez pas cette intégration pour une voiture nord-américaine en vous attendant à ce qu'elle fonctionne d'emblée.
