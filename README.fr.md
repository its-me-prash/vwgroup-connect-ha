...
| **VW US/CA** | ✅ Bidirectionnel | ✅ Complet | cloud VW NA (nécessite le sélecteur de pays US/CA + S-PIN). Le Canada se connecte désormais sur son propre serveur avec son propre client d'application et affiche des données complètes, confirmé sur un ID.4 canadien réel ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
