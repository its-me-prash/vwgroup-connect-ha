...
- **Contrôle :** verrouillage/déverrouillage, démarrage/arrêt de la climatisation, démarrage/arrêt de la charge, chauffage des vitres, minuteries de départ, réglage du SoC cible / de la température / du courant de charge maximal, klaxon-et-appel de phares (avec un choix de durée, et feux seuls ou klaxon en plus), réveil, rafraîchissement, recherche de bornes de recharge *(la disponibilité dépend de la marque et du modèle)*.
