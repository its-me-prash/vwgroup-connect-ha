...
| **VW USA/CA** | ✅ Kaksisuuntainen | ✅ Täysi | VW NA -pilvi (vaatii USA/CA-maavalitsimen + S-PIN:n). ⚠️ Kanadalaiset kirjautumiset ohjautuivat palvelimelle, jolla ei ole toimivaa authorize-päätepistettä; korjattu versiossa v2.26.1 ja odottaa vahvistusta oikealta kanadalaiselta tililtä ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Pohjois-Amerikka on kokeellinen.** **Audi USA/CA** -kirjautuminen on kytketty, mutta sitä ei ole koskaan vahvistettu oikealla tilillä ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** toimii, ja reititysvirhe, joka rikkoi osan kanadalaisista kirjautumisista, korjattiin versiossa v2.26.1, vaikka kukaan ei ole vielä vahvistanut sitä oikealla kanadalaisella tilillä ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Älä valitse tätä integraatiota pohjoisamerikkalaiseen autoon olettaen, että se vain toimii.
