...
| **VW USA/CA** | ✅ Bidirezionale | ✅ Completo | cloud VW NA (richiede il selettore di paese USA/CA + S-PIN). ⚠️ Gli accessi canadesi venivano instradati verso un host privo di un endpoint authorize funzionante; corretto nella v2.26.1 e in attesa di conferma da un account canadese reale ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)) |
...
- **Il Nord America è sperimentale.** L'accesso **Audi USA/CA** è cablato ma non è mai stato confermato su un account reale ([#13](https://github.com/its-me-prash/vwgroup-connect-ha/issues/13)). **VW USA/CA** funziona, e un difetto di instradamento che impediva alcuni accessi canadesi è stato corretto nella v2.26.1, anche se nessuno l'ha ancora confermato su un account canadese reale ([#990](https://github.com/its-me-prash/vwgroup-connect-ha/issues/990)). Non scegliere questa integrazione per un'auto nordamericana aspettandoti che funzioni e basta.
