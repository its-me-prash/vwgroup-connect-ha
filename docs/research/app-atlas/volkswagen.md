...
| Field | Value |
|---|---|
| Android package ID | `com.volkswagen.weconnect` |
| Expected backend | `cariad_bff` |
...
|---|---|
| APKMirror | `volkswagen-ag/volkswagen-we-connect-id` |
| Uptodown | `volkswagen-we-connect-id` |

## Current version

| | |
|---|---|
| Latest version-name | `4.2.1` |
| Source that responded | `google_play` |
| Previously cached version | `4.1.1` |
