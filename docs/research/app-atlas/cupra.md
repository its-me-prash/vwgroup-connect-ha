...
| Field | Value |
|---|---|
| Android package ID | `com.cupra.mycupra` |
| Expected backend | `ola` |
| OLA enforcement known? | **YES** (since 2026-05-20) |

## Configured sources (fallback chain)

| Source | Configured value |
|---|---|
| APKMirror | `seat-cupra-s-a/my-cupra-app` |
| Uptodown | `my-cupra` |
...
_Last extracted: 2026-09-17T08:57:59 (for version `2.22.1`)_
